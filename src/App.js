  ...
  const renderSubitems = (subitems, level = 0) => {
    return subitems.map((subitem) => (
      <div key={subitem.id} className={`mt-4 ${level > 0 ? "ml-4" : ""}`}>
        ...
        {subitem.imagePosition === "top" &&
          Array.isArray(subitem.images) &&
      ...
      <div className="max-w-6xl mx-auto px-4">
        ...
        {selectedItem ? (
          <div className="bg-white rounded-lg shadow-md p-6 mb-8 transition-all duration-300">
            ...
            {selectedItemData.imagePosition === "top" &&
            ...
            {selectedItemData.imagePosition === "bottom" &&
              Array.isArray(selectedItemData.images) &&
              selectedItemData.images.length > 0 && (
                <div className="flex flex-wrap justify-center gap-4 mb-6">
                  {selectedItemData.images.map((src, idx) => (
